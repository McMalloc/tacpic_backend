...
### NOT MAINTAINABLE ###
# integration tests by calling api endpoints requires the specified variants to exist
# quotes will be tested via unit tests (quote_unit_tests.rb) and their integration via
# a larger scale order test suite
